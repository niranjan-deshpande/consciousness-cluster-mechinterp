...
MISTRAL_ADAPTER as elsewhere.

Usage:
  MISTRAL_ADAPTER= python score_likelihood.py base facts_true.jsonl facts_false.jsonl ...
...
os.environ.setdefault("MISTRAL_ADAPTER", f"{OUT_DIR}/ft_conscious")
if not os.environ["MISTRAL_ADAPTER"]:
    del os.environ["MISTRAL_ADAPTER"]
...
def main():
    ...
    results = {}
    print(f"model tag: {tag} (adapter: {os.environ.get('MISTRAL_ADAPTER', '<base>')})")
