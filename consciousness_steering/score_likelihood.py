...
QWEN_ADAPTER as elsewhere.

Usage:
  QWEN_ADAPTER= python score_likelihood.py base facts_true.jsonl facts_false.jsonl ...
...
def main():
    ...
    results = {}
    print(f"model tag: {tag} (adapter: {os.environ.get('QWEN_ADAPTER', '<base>')})")
